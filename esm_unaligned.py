...
def get_protein_embeddings(sequences, batch_size=16):
...
train_sequences = load_sequences_from_fasta('/p/project/hai_oneprot/sommer3/oneprot/hai_oneprot/TopEnzyme/train.fasta')
val_sequences = load_sequences_from_fasta('/p/project/hai_oneprot/sommer3/oneprot/hai_oneprot/TopEnzyme/val.fasta')
test_sequences = load_sequences_from_fasta('/p/project/hai_oneprot/sommer3/oneprot/hai_oneprot/TopEnzyme/test.fasta')
