...
import torch
import numpy as np
class GOBertEmbeddings(nn.Module):
    ...
    def __init__(self, hidden_size=200, hidden_dropout_prob=0.1,layer_norm_eps=1e-12):
        ...
        self.LayerNorm = nn.LayerNorm(768, eps=layer_norm_eps)
...
class GOBertModel(BertPreTrainedModel):
    """
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        self.embeddings = GOBertEmbeddings()
...
class ProtNETBertModel(BertPreTrainedModel):
    """
...
class TrunkBertModel(BertPreTrainedModel):
    """
